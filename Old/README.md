...
# Bootloaders / OS
**-----OpenCore-----**
- <img src="https://github.com/KerKerOgh/MSI-Prestige-15-Hackintosh/blob/master/Old/Screenshot2.png/" width=512>
- OpenCore: v0.6.2
- MacOS: Catalina 10.15.7 / BigSur 11.0
- SMBIOS: MacBook Pro 15.4
- Config: [In repository](https://github.com/KerKerOgh/MSI-Prestige-15-Hackintosh/blob/master/Old/OpenCore/config.plist)
...
**------Clover------**
- <img src="https://github.com/KerKerOgh/MSI-Prestige-15-Hackintosh/blob/master/Old/Screenshot.png/" width=512>
- Clover: v5122
- MacOS: Catalina 10.15.7
- SMBIOS: MacBook Pro 15.4
- Config: [In repository](https://github.com/KerKerOgh/MSI-Prestige-15-Hackintosh/blob/master/Old/Clover/Configs/config.plist)
...
- Required efi drivers
  ...
  - OcQuirks **(included in Clover is broken! Need to download separately)** : https://github.com/ReddestDream/OcQuirks/releases
    ...
    - OcQuirks.plist [from repository](https://github.com/KerKerOgh/MSI-Prestige-15-Hackintosh/blob/master/Old/Clover/Configs/OcQuirks.plist)
